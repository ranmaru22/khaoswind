...
class GameData(object):
    ...
    def is_north(self, location):
        return self.current_loc.y + 1 == location.y

    def is_east(self, location):
        return self.current_loc.x + 1 == location.x

    def is_south(self, location):
        return self.current_loc.y - 1 == location.y

    def is_west(self, location):
        return self.current_loc.x - 1 == location.x
